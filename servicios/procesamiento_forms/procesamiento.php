...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO consultas (nombre_dueño, nombre_mascota, fecha_cita, razon_cita) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);

    // Verificar si la consulta preparada fue exitosa
    if ($stmt) {
        $stmt->bind_param("ssss", $nombre_dueño, $nombre_mascota, $fecha_cita, $razon_cita);
